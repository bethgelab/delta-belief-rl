...
# Minimal reward schema mirroring guess_my_city style
...
def per_turn_reward_fn(
    ...
    _ = action, obs  # unused
    signals = _default_reward_signals if reward_signals is None else _default_reward_signals | reward_signals
...
def traj_reward_fn(
    ...
    """Fake trajectory reward matching guess_my_city signature.
